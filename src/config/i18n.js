...
export const I18N = {
  ...
  lookup_history_helper: {
    zh: `查词历史会记录您的翻译查询记录，包括原文、译文、翻译服务以及查询时间。`,
    en: `Lookup history records your translation queries, including original text, translated text, translation service, and query time.`,
    zh_TW: `查詢歷史會記錄您的翻譯查詢記錄，包括原文、譯文、翻譯服務以及查詢時間。`,
    ja: `検索履歴は、翻訳クエリを記録し、原文、翻訳文、翻訳サービス、および照会時間が含まれます。`,
    ko: `검색 기록은 원문, 번역문, 번역 서비스 및 검색 시간을 포함한 번역 쿼리를 기록합니다.`,
  },
  lookup_history_enabled: {
    zh: `启用查词历史`,
    en: `Enable Lookup History`,
    zh_TW: `啟用查詢歷史`,
    ja: `検索履歴を有効にする`,
    ko: `검색 기록 사용`,
  },
  lookup_history_max_count: {
    zh: `历史记录数量`,
    en: `History Max Count`,
    zh_TW: `歷史記錄數量`,
    ja: `履歴の最大記録数`,
    ko: `기록 최대 개수`,
  },
  lookup_history_max_count_helper: {
    zh: `保存最近N条查词记录，范围1-100000`,
    en: `Save the last N lookup records, range 1-100000`,
    zh_TW: `保存最近N條查詢記錄，範圍1-100000`,
    ja: `直近N件の検索履歴を保存、範囲1-100000`,
    ko: `최근 N개의 검색 기록을 저장, 범위 1-100000`,
  },
  no_lookup_history: {
    zh: `暂无查词历史`,
    en: `No lookup history yet`,
    zh_TW: `暫無查詢歷史`,
    ja: `検索履歴はありません`,
    ko: `검색 기록이 없습니다`,
  },
  ...
  no_search_results: {
    ...
    zh_TW: `沒有找到匹配的結果`,
    ja: `一致する結果が見つかりませんでした`,
    ko: `일치하는 결과를 찾을 수 없습니다`,
  },
  touch_setting: {
    zh: `触屏设置`,
    en: `Touch Setting`,
